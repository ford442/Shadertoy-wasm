...
boost::container::vector<emscripten_align1_float>floatData(data.size()/sizeof(float));
...
wgpu_queue_write_texture(WGPU_Queue.at(0,0,0),&wict.at(4,4),floatData.data(),bytesPerRow,szeV.at(7,7),szeV.at(7,7),1,1);
