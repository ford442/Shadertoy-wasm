...
scanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.5;position: absolute;z-index:999994;top:0;left:0;transform: rotate("+rta+"deg)");
...
icanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.5;position: absolute;z-index:999995;top:0;left:0;transform: rotate("+rtb+"deg)");
...
bcanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.5;position: absolute;z-index:999996;top:0;left:0;transform: rotate("+rtc+"deg)");
