...
function rrra(rta){
scanvas.setAttribute("style","position: absolute;top:0;transform: rotate("+rta+"deg)");
// cnP.setAttribute("style","transform: rotate("+rta+"deg)");
// cnPB.setAttribute("style","transform:rotate("+rta+"deg);");
}
function rrrb(rtb){
icanvas.setAttribute("style","position: absolute;top:0;transform: rotate("+rtb+"deg)");
// cnP.setAttribute("style","transform: rotate("+rtb+"deg)");
// cnPB.setAttribute("style","transform:rotate("+rtb+"deg);");
}
function rrrc(rtc) {
bcanvas.setAttribute("style","position: absolute;top:0;transform: rotate("+rtc+"deg)");
