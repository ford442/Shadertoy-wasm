...
rgbd[i+3]=rgbd[i+3]-(rgb-125);
rgbd2[i+3]=rgbd[i+3]-(rgb-125);
rgbd3[i+3]=rgbd[i+3]-(rgb-125);
// rgbd[i+3]=0;
// rgbd2[i+3]=0;
// rgbd3[i+3]=0;
}
...
function rrra(rta){
// var opc =parseFloat(360 - (rta % knb + knb) % knb)/360;
scanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.666;position: absolute;z-index:999994;top:0;left:0;transform: rotate("+rta+"deg)");
...
icanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.555;position: absolute;z-index:999995;top:0;left:0;transform: rotate("+rtb+"deg)");
...
bcanvas.setAttribute("style","backgroundColor:'rgba(255,255,255,0.0)';opacity:0.444;position: absolute;z-index:999996;top:0;left:0;transform: rotate("+rtc+"deg)");
