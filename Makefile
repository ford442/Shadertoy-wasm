...
b3_wasm_loader:
	 ...
	 $(LINK_SIMD_FLAGS) -sUSE_GLFW=0 -sASSERTIONS=0 -march=broadwell -sMEMORY64=2 \
...
mlc_ai:
	 em++ src/vanilla/mlc.cpp $(STDS) -m64 -mtune=wasm64 -flto -flto=thin -pipe -ffp-contract=fast \
	 ...
	 em++ -O3 -sEVAL_CTORS=0 -m64 -sMALLOC=mimalloc -sWASMFS=1 -fopenmp-simd \
	 ...
	 -DCOMPUTE -o $(BETA_BIN_NAME)-mlc.js -sSTRICT=1 -sSTRICT_JS=0 \
	 $(LINK_SIMD_FLAGS) -sUSE_GLFW=0 -sASSERTIONS=0 -sMEMORY64 \
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm64 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer -mtune=wasm64 \
	 -sALLOW_MEMORY_GROWTH=0 -sMAXIMUM_MEMORY=4gb -sINITIAL_HEAP=1024mb -ffunction-sections -fdata-sections \
	 -sABORT_ON_WASM_EXCEPTIONS=0 -sEMULATE_FUNCTION_POINTER_CASTS=0 \
	 -sUSE_SDL=0 -sFORCE_FILESYSTEM=1 -sAUTO_JS_LIBRARIES=0 -sAUTO_NATIVE_LIBRARIES=0 -sDISABLE_EXCEPTION_THROWING=1 \
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 \
	 -sASYNCIFY=0 \
	 mlc.o --output_eol linux -rtlib=compiler-rt --closure 0 --closureFriendly \
	 -sMODULARIZE=0 -sDISABLE_EXCEPTION_CATCHING=1 -sWASM_LEGACY_EXCEPTIONS=0
...
b3_wasm_loader_lto_32_test3:
	 ...
	 -mextended-const -O3 -fno-strict-aliasing $(SIMD_FLAGS) -sMEMORY64 -c -fno-rounding-math -fcx-limited-range \
	 -fassociative-math -freciprocal-math -fno-signed-zeros --target=wasm64 -sSTRICT=1
	 em++ -O3 -sEVAL_CTORS=0 -m64 -sMALLOC=emmalloc -sWASMFS=1 -fopenmp-simd \
	 -sWASM_BIGINT=1 -mextended-const -dead_strip -mbulk-memory -matomics \
	 -pipe -DQUAD -DDOUBLE -fno-exceptions \
	 -stdlib=libc++abi-noexcept -fno-rounding-math -fassociative-math \
	 -freciprocal-math -fno-signed-zeros \
	 ...
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 \
	 -sASYNCIFY=0 -sEXPORTED_FUNCTIONS='["_main"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
	 --pre-js js/rSlider.js --pre-js js/slideOut.js --pre-js js/pyodide.js --js-library lib/lib_webgpu.js \
	 wasm_loader_32.o --output_eol linux -rtlib=compiler-rt --closure 0 --closureFriendly \
	 -sMODULARIZE=1 -sEXPORT_NAME='libload' -sDISABLE_EXCEPTION_CATCHING=1 -sWASM_LEGACY_EXCEPTIONS=0
...
loader_es6:
	 ...
	 -mmutable-globals -mnontrapping-fptoint -msign-ext  \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer -mtune=wasm64 \
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY= -ffunction-sections -fdata-sections \
	 -sABORT_ON_WASM_EXCEPTIONS=0 -sEMULATE_FUNCTION_POINTER_CASTS=0 \
	 -sUSE_SDL=0 -sFORCE_FILESYSTEM=1 -sAUTO_JS_LIBRARIES=0 -sAUTO_NATIVE_LIBRARIES=0 -sDISABLE_EXCEPTION_THROWING=1 \
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 \
	 -sASYNCIFY=1 -sEXPORTED_FUNCTIONS='["_main"]' -sEXPORTED_RUNTIME_METHODS='["ccall","callMain"]' \
	 --pre-js js/rSlider.js --pre-js js/slideOut.js --pre-js js/pyodide.js \
	 wasm_loader_32.o --output_eol linux -rtlib=compiler-rt --closure 0 --closureFriendly \
	 -sMODULARIZE=1 -sEXPORT_ES6=1 -sDISABLE_EXCEPTION_CATCHING=1 -sWASM_LEGACY_EXCEPTIONS=0
...
loader_pm:
	 ...
	 -DCOMPUTE -o $(BETA_BIN_NAME)-load-pm.js -sSTRICT=1 -sSTRICT_JS=0 \
	 $(LINK_SIMD_FLAGS) -sUSE_GLFW=0 -sASSERTIONS=0 -sMEMORY64 \
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm64 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext  \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer -mtune=wasm64 \
...
b3_compute_mod_test4:
	 ...
	 -I/content/RAMDRIVE2/b3/boost_1_88_0/ -c $(nBOOST_FLAGS) $(SIMD_FLAGS)
	 ...
	 -sABORT_ON_WASM_EXCEPTIONS=0 -sEMULATE_FUNCTION_POINTER_CASTS=1 \
	 -sUSE_SDL=0 -sFORCE_FILESYSTEM=1 -sWASM_LEGACY_EXCEPTIONS=0 -sDISABLE_EXCEPTION_THROWING=0 \
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=0 -sIGNORE_MISSING_MAIN=0 \
...
b3_onnx6:
	 ...
	 $(LINK_SIMD_FLAGS) -sUSE_GLFW=0 -sASSERTIONS=0 -march=broadwell \
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm32 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext  \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer -mtune=wasm32 \
...
b3_apng:
	 ...
	 $(LINK_SIMD_FLAGS) -sUSE_GLFW=0 -sASSERTIONS=1 -march=broadwell \
...
b3_compute_mod_test5:
	 ...
	 -fexcess-precision=fast -flto -flto=thin -fexperimental-library -fopenmp-simd \
	 -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -fno-math-errno \
	 -mmutable-globals -mbulk-memory -matomics -mnontrapping-fptoint -msign-ext  \
	 ...
	 em++ $(mLDFLAGS) -O3 --bind -lembind -flto -flto=thin -sWASM_BIGINT=1 -sEVAL_CTORS=0 -fopenmp-simd \
	 -ffast-math -mextended-const -mbulk-memory -sEXIT_RUNTIME=0 \
	 ...
	 -sALLOW_MEMORY_GROWTH=0 -sMAXIMUM_MEMORY=4gb -sINITIAL_HEAP=1024mb -lmath.js -lhtml5.js -lint53.js \
	 ...
	 -sASYNCIFY=0 -sASYNCIFY_STACK_SIZE=81920 -sASYNCIFY_IMPORTS='["wgpu_buffer_map_sync"]' -sEXPORTED_RUNTIME_METHODS='["ccall","FS"]' -sMALLOC='emmalloc' \
...
b3_compute_handle:
	 ...
	 -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -ffp-contract=fast \
	 -fexcess-precision=fast -sENVIRONMENT=web \
	 -DCOMPUTE -o $(BETA_BIN_NAME)-handle.js -sSTRICT_JS=0 -sSTRICT=1 -ffunction-sections -fdata-sections \
	 $(nBOOST_FLAGS) $(LINK_SIMD_FLAGS) $(xGL_FLAGS) -sASSERTIONS=0 -mtune=wasm32 \
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm32 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer \
	 ...
	 -sUSE_SDL=0 -sFORCE_FILESYSTEM=1 -sAUTO_JS_LIBRARIES=1 -sAUTO_NATIVE_LIBRARIES=1 \
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 \
	 -sEXPORTED_FUNCTIONS='["_main","_startWebGPUi","_startWebGPUbi","_startWebGPUC","_zoomIn","_zoomOut","_panRight","_panLeft","_panUp","_panDown"]' \
	 -sASYNCIFY=2 -sASYNCIFY_STACK_SIZE=81920 -sASYNCIFY_IMPORTS='["wgpu_buffer_map_sync"]' -sEXPORTED_RUNTIME_METHODS='["ccall","FS"]' -sMALLOC='emmalloc' \
	 --js-library lib/lib_webgpu.js --js-library lib/lib_demo.js -sWASMFS=1 \
	 --js-library lib/library_miniprintf.js --closure-args=--externs=lib/webgpu-closure-externs.js \
	 webgpu_handle.o --output_eol linux -rtlib=compiler-rt --closure 0 \
	 -sMODULARIZE=1 -sEXPORT_NAME='lib1ink' -sWASM_LEGACY_EXCEPTIONS=0
...
b3_wasm_loader_wasm:
	 ...
	 $(LINK_SIMD_FLAGS) -sASSERTIONS=0 -march=broadwell \
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm32 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext  \
	 -fwhole-program-vtables -polly -polly-position=before-vectorizer -mtune=wasm32 \
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=384mb -lmath.js -lhtml5.js -lint53.js \
...
b3_compute_eglx:
	 ...
	 -ffast-math -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -fno-math-errno \
	 -mmutable-globals -mbulk-memory -matomics -mnontrapping-fptoint -msign-ext  \
	 -mextended-const -O3 $(xGL_FLAGS) -fno-strict-aliasing -march=broadwell \
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -I/content/RAMDRIVE2/b3/highway/ -c $(BOOST_FLAGS) $(SIMD_FLAGS)
