...
video_sdl3:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/video/video_sdl3.cpp -O0 -I/content/RAMDRIVE2/b3/include/vanilla/ -c -fPIC -pipe $(STDS) $(BOOST_FLAGS) $(SIMD_FLAGS)
	 em++ video_sdl3.o -O0 $(LDFLAGSb) $(STDS) -sMAIN_MODULE=1 --bind -lembind -fPIC -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o $(BIN_NAME)-resC2.js $(GL_FLAGS) $(BOOST_FLAGS) $(LINK_FLAGS) $(LINK_SIMD_FLAGS) \
