...
b3_cropcircle:
	 em++ $(STDS) -c src/vanilla/cropcircle.cpp -O2 -m32 -mtune=wasm32 $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS)
...
b3_cropcircle_64:
	 em++ $(STDS) -c src/vanilla/cropcircle.cpp -O2 -m64 -mtune=wasm64 $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS) -sMEMORY64=1
...
b3_cropcircle_rot:
	 em++ $(STDS) -c src/vanilla/cropcircle_rotate.cpp -O2 -m32 -mtune=wasm32 $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS)
...
b3_cropcircle_rot_avg:
	 em++ $(STDS) -c src/vanilla/cropcircle_rotate_avg.cpp -O2 -m32 -mtune=wasm32 $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS)
