...
b3_wasm_loader_lto_32_test3_thread:
	em++ src/vanilla/wasm_loader_32.cpp $(STDS) -msimd128 -mavx2 -pthread -openmp-simd -O3 -m32 -mtune=wasm32 -sSHARED_MEMORY=1 -sWASM_WORKERS=0 \
	    -ffast-math -fno-strict-aliasing -c -DNDEBUG=1 -DBOOST_HAS_THREADS=1 \
	    -DBOOST_UBLAS_USE_LONG_DOUBLE=1 -DBOOST_UBLAS_NDEBUG=1 -o wasm_loader_32.o
	em++ wasm_loader_32.o -O3 -msimd128 -mavx2 -sPROXY_TO_PTHREAD=1 -sPTHREAD_POOL_SIZE=4 -sSHARED_MEMORY=1 -sWASM_WORKERS=0 \
...
b3_wasm_loader_lto_32_test3_thread__:
	 ...
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1024mb -ffunction-sections -fdata-sections \
	 -sABORT_ON_WASM_EXCEPTIONS=0 -sEMULATE_FUNCTION_POINTER_CASTS=0 -s PROXY_TO_PTHREAD=1 -s PTHREAD_POOL_SIZE=4 \
	 -sUSE_SDL=0 -sFORCE_FILESYSTEM=1 -sAUTO_JS_LIBRARIES=0 -sAUTO_NATIVE_LIBRARIES=0 -sDISABLE_EXCEPTION_THROWING=1 \
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 -sPTHREAD_POOL_SIZE=4 \
	 -sASYNCIFY=0 -sEXPORTED_FUNCTIONS='["_main"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
	 --pre-js js/rSlider.js --pre-js js/slideOut.js --pre-js js/pyodide.js \
...
b3_wasm_loader_lto_64_test3_thread:
