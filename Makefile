...
SIMD_FLAGS := -DSIMD=2 -mavx2 -msimd128 -mrelaxed-simd -fopenmp-simd
...
LINK_SIMD_FLAGS := -DSIMD=2 -mavx2 -mrelaxed-simd -msimd128 -fopenmp-simd
...
GL_FLAGS += -sFULL_ES3=1 -sFULL_ES2=0 -sLEGACY_GL_EMULATION=0 -lGL -lEGL -sUSE_GLFW=0 -sUSE_REGAL=0 \
	 ...
	 -sOFFSCREENCANVAS_SUPPORT=1 -sDISABLE_DEPRECATED_FIND_EVENT_TARGET_BEHAVIOR=1 -s GL_POOL_TEMP_BUFFERS=0 \
...
video_resurection_webgpuc4:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/video/video_jebusc3.cpp -O0 -sSTRICT=1 -I/content/RAMDRIVE2/b3/include/vanilla/ -c -pipe -flto -flto=thin $(STDS) $(BOOST_FLAGS) $(SIMD_FLAGS)
	 em++ video_jebusc3.o -O0 -sSTRICT=1 -sSTRICT_JS=0 $(LDFLAGSb) $(STDS) --bind -lembind -fPIC -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o $(BIN_NAME)-resC2.js $(GL_FLAGS) $(BOOST_FLAGS) $(LINK_FLAGS_strict) $(LINK_SIMD_FLAGS) \
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -sFORCE_FILESYSTEM=1 -sUSE_SDL=2 -sMALLOC=mimalloc -sWASMFS=1 -pipe -flto -flto=thin -dead_strip \
	 -sASYNCIFY=0 -sASYNCIFY_STACK_SIZE=81920 -sASYNCIFY_IMPORTS=['wgpu_buffer_map_sync','navigator_gpu_request_adapter_sync','wgpu_adapter_request_device_sync'] \
	 -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3"]' -sEXPORTED_RUNTIME_METHODS='["ccall","HEAPF64"]' \
	 --pre-js js/fluid.js --pre-js js/flui.js --pre-js js/setUp.js --pre-js js/startUp.js -lmath.js -lhtml5.js -lint53.js \
	 --js-library lib/lib_demo.js --js-library lib/library_miniprintf.js --js-library lib/lib_webgpu.js --closure-args=--externs=lib/webgpu-closure-externs.js \
	 --post-js js/pagec_webgpuc.js --pre-js js/rSlider.js --pre-js js/slideOut.js --pre-js js/gpu-browser.js --closure 0

video_sdl3:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static -fPIC
	 em++ lib/lib_webgpu.cpp $(STDS) -static -fPIC
	 ...
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -stdlib=libc++ -sFORCE_FILESYSTEM=1 -sUSE_SDL=3 -sMALLOC=mimalloc -sWASMFS=1 -pipe -dead_strip \
	 -sASYNCIFY=1 -sASYNCIFY_IMPORTS=['wgpu_buffer_map_sync','navigator_gpu_request_adapter_sync','wgpu_adapter_request_device_sync'] \
	 -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3"]' -sEXPORTED_RUNTIME_METHODS='["ccall","HEAPF64"]' \
	 --pre-js js/fluid.js --pre-js js/flui.js --pre-js js/setUp.js --pre-js js/startUp.js -lmath.js -lhtml5.js -lint53.js \
	 --js-library lib/lib_demo.js --js-library lib/library_miniprintf.js --js-library lib/lib_webgpu.js --closure-args=--externs=lib/webgpu-closure-externs.js \
...
video_resurection_webgpuc64:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/video/video_jebusc2.cpp -m64 --target=wasm64 -sMEMORY64=1 -O1 -I/content/RAMDRIVE2/b3/include/vanilla/ -c -pipe -flto -flto=thin $(STDS) $(BOOST_FLAGS) $(SIMD_FLAGS_64)
	 em++ video_jebusc2.o -m64 --target=wasm64 -mtune=wasm64 -sMEMORY64=1 -O1 $(LDFLAGSb) $(STDS) --bind -lembind -fPIC -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o $(BIN_NAME)-resC2.js $(GL_FLAGS) $(BOOST_FLAGS) $(LINK_FLAGS) $(LINK_SIMD_FLAGS) \
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -sFORCE_FILESYSTEM=1 -sUSE_SDL=2 -sMALLOC=mimalloc -sWASMFS=1 -pipe -flto -flto=thin -dead_strip \
	 -sASYNCIFY=1 -sASYNCIFY_IMPORTS=['wgpu_buffer_map_sync','navigator_gpu_request_adapter_sync','wgpu_adapter_request_device_sync'] \
