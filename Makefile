...
video_resurection_webgpuc4:
	 ...
	 em++ video_jebusc3.o -O0 -sSTRICT_JS=0 $(LDFLAGSb) $(STDS) --bind -flto -flto=thin -lembind -fPIC -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o $(BIN_NAME)-resC2.js $(GL_FLAGS) $(BOOST_FLAGS) $(LINK_FLAGS_strict) $(LINK_SIMD_FLAGS) \
