...
{{{
  // Default globalThis.WEBGPU_DEBUG to 0 (false) if not already defined.
  // This ensures debug utilities are off by default unless explicitly enabled
  // by C++ -DWEBGPU_DEBUG=1 or by manually setting globalThis.WEBGPU_DEBUG in the browser console.
  globalThis.WEBGPU_DEBUG = globalThis.WEBGPU_DEBUG === undefined ? 0 : globalThis.WEBGPU_DEBUG;
